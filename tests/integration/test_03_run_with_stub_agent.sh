...
assert_file_contains "$STUB_OUT/codex.args" "--ask-for-approval" "run passes canonical codex approval arg"
assert_file_contains "$STUB_OUT/codex.args" "never" "run passes canonical codex approval mode"
assert_file_contains "$STUB_OUT/codex.args" "--sandbox" "run passes canonical codex sandbox arg"
assert_file_contains "$STUB_OUT/codex.args" "workspace-write" "run passes canonical codex sandbox mode"
