...
2. Затем выполни реализацию по шагам из staged prompts.
3. После code changes обязательно выполни релевантные проверки.
4. Заверши stage через `complete-stage` с `--stage implementation`.
